...
public class RecipesCrafting
{
	public void a(CraftingManager paramCraftingManager)
	{
		...
		paramCraftingManager.registerShapedRecipe(new ItemStack(Block.ENDER_CHEST), new Object[] { "###", "#E#", "###", Character.valueOf('#'), Block.OBSIDIAN, Character.valueOf('E'), Item.EYE_OF_ENDER });
 ...
 * Qualified Name:		 net.minecraft.server.RecipesCrafting
