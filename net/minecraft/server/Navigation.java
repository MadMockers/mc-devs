...
public class Navigation
{
	...
	private void h() {
		...
		if (this.g - this.h > 100) {
			if (localVec3D.distanceSquared(this.i) < 2.25D) g();
			this.h = this.g;
			this.i.a = localVec3D.a;
			this.i.b = localVec3D.b;
			this.i.c = localVec3D.c;
	...
	private Vec3D i() {
		return Vec3D.a().create(this.a.locX, j(), this.a.locZ);
	}

	private int j() {
		if ((!this.a.H()) || (!this.m)) return (int)(this.a.boundingBox.b + 0.5D);
	...
	private boolean k() {
		return (this.a.onGround) || ((this.m) && (l()));
	}
	...
	private void m() {
		if (this.b.j(MathHelper.floor(this.a.locX), (int)(this.a.boundingBox.b + 0.5D), MathHelper.floor(this.a.locZ))) return;

		for (int n = 0; n < this.c.d(); n++) {
			PathPoint localPathPoint = this.c.a(n);
			if (this.b.j(localPathPoint.a, localPathPoint.b, localPathPoint.c)) {
				this.c.b(n - 1);
				return;
			}
		}
		...
		for (int i2 = n; i2 < n + paramInt4; i2++) {
			for (int i3 = i1; i3 < i1 + paramInt6; i3++) {
				...
				if (d1 * paramDouble1 + d2 * paramDouble2 >= 0.0D) {
					...
					if ((localMaterial == Material.WATER) && (!this.a.H())) return false;
			...
			for (int i1 = paramInt2; i1 < paramInt2 + paramInt5; i1++)
				for (int i2 = paramInt3; i2 < paramInt3 + paramInt6; i2++)
				{
					...
					if (d1 * paramDouble1 + d2 * paramDouble2 >= 0.0D) {
						...
						if ((i3 > 0) && 
							(!Block.byId[i3].c(this.b, n, i1, i2))) return false;
					}
				}
		}
		return true;
