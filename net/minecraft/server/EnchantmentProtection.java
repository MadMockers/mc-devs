...
public class EnchantmentProtection extends Enchantment
{
	...
	private static final int[] C = { 11, 8, 6, 8, 6 };
	...
	public int a(int paramInt, DamageSource paramDamageSource)
	{
		...
		if (((this.a == 3) && (paramDamageSource == DamageSource.EXPLOSION)) || (paramDamageSource == DamageSource.EXPLOSION2)) return i;
		if ((this.a == 4) && (paramDamageSource.a())) return i;
		return 0;
	}
	...
	public boolean a(Enchantment paramEnchantment)
	{
		if ((paramEnchantment instanceof EnchantmentProtection)) {
			...
			return (this.a == 2) || (localEnchantmentProtection.a == 2);
		}
 ...
 * Qualified Name:		 net.minecraft.server.EnchantmentProtection
