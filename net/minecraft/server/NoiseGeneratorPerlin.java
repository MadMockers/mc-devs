...
public class NoiseGeneratorPerlin extends NoiseGenerator
{
	...
	public void a(double[] paramArrayOfDouble, double paramDouble1, double paramDouble2, double paramDouble3, int paramInt1, int paramInt2, int paramInt3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7)
	{
		...
		if (paramInt2 == 1) {
			...
			for (int i1 = 0; i1 < paramInt1; i1++) {
				...
				for (i4 = 0; i4 < paramInt3; i4++) {
					...
					k = this.d[(i3 + 1)] + 0;
					m = this.d[k] + i6;
					d1 = b(d5, a(this.d[j], d4, d6), a(this.d[m], d4 - 1.0D, 0.0D, d6));
					d2 = b(d5, a(this.d[(j + 1)], d4, 0.0D, d6 - 1.0D), a(this.d[(m + 1)], d4 - 1.0D, 0.0D, d6 - 1.0D));
		...
		int m = -1;
		int i7 = 0; int i8 = 0; int i9 = 0; int i10 = 0; int n = 0; int i11 = 0;
			...
			for (int i12 = 0; i12 < paramInt3; i12++) {
				...
				for (int i15 = 0; i15 < paramInt2; i15++) {
					...
					if ((i15 == 0) || (i17 != m)) {
						...
						d10 = b(d7, a(this.d[i8], d6, d14, d12), a(this.d[n], d6 - 1.0D, d14, d12));
						d4 = b(d7, a(this.d[i9], d6, d14 - 1.0D, d12), a(this.d[i11], d6 - 1.0D, d14 - 1.0D, d12));
						d11 = b(d7, a(this.d[(i8 + 1)], d6, d14, d12 - 1.0D), a(this.d[(n + 1)], d6 - 1.0D, d14, d12 - 1.0D));
						d5 = b(d7, a(this.d[(i9 + 1)], d6, d14 - 1.0D, d12 - 1.0D), a(this.d[(i11 + 1)], d6 - 1.0D, d14 - 1.0D, d12 - 1.0D));
					}
