...
public class PathfinderGoalMeleeAttack extends PathfinderGoal
{
	...
	public boolean b()
	{
		...
		return !this.f ? false : !this.b.getNavigation().f() ? true : !this.c.isAlive() ? false : entityliving == null ? false : this.b.d(MathHelper.floor(this.c.locX), MathHelper.floor(this.c.locY), MathHelper.floor(this.c.locZ));
	}
