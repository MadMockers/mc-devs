	...
	implements IMonster
{
	...
	protected void be() {
		...
		if ((this.target != null) && (this.target.e(this) < d4 * d4)) {
			...
			this.aq = (this.yaw = -(float)Math.atan2(d5, d7) * 180.0F / 3.141593F);
			if (l(this.target)) {
				if (this.f == 10) {
				...
				if (this.f == 20) {
					...
					entityfireball.locY = (this.locY + this.length / 2.0F + 0.5D);
			...
			this.aq = (this.yaw = -(float)Math.atan2(this.motX, this.motZ) * 180.0F / 3.141593F);
			if (this.f > 0) {
				this.f -= 1;
			}
		}
