	...
	private boolean b() {
		...
		while (iterator.hasNext()) {
			...
			if ((this.f != null) && (this.f.getDoorCount() >= 10) && (this.f.d() >= 20) && (this.f.getPopulationCount() >= 20)) {
				...
				while (i < 10) {
					this.g = (chunkcoordinates.x + (int)(MathHelper.cos(this.world.random.nextFloat() * 3.141593F * 2.0F) * f * 0.9D));
					this.h = chunkcoordinates.y;
					this.i = (chunkcoordinates.z + (int)(MathHelper.sin(this.world.random.nextFloat() * 3.141593F * 2.0F) * f * 0.9D));
					flag = false;
	...
	private Vec3D a(int i, int j, int k)
	{
		for (int l = 0; l < 10; l++) {
			...
			if ((this.f.a(i1, j1, k1)) && (SpawnerCreature.a(EnumCreatureType.MONSTER, this.world, i1, j1, k1))) {
				return Vec3D.a().create(i1, j1, k1);
			}
		}
