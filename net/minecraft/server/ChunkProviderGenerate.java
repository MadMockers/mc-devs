	...
	implements IChunkProvider
{
	...
	public void a(int paramInt1, int paramInt2, byte[] paramArrayOfByte)
	{
		...
		this.z = this.p.getWorldChunkManager().getBiomes(this.z, paramInt1 * 4 - 2, paramInt2 * 4 - 2, i4 + 5, i6 + 5);
					...
					if (i8 <= 0 + this.k.nextInt(5)) {
						...
						if (i10 == 0)
							...
							if (i5 == -1) {
								...
								i5 = i4;
								if (i8 >= i1 - 1) paramArrayOfByte[i9] = i6; else
	...
	public Chunk getOrCreateChunk(int paramInt1, int paramInt2) {
		...
		this.z = this.p.getWorldChunkManager().getBiomeBlock(this.z, paramInt1 * 16, paramInt2 * 16, 16, 16);
		a(paramInt1, paramInt2, arrayOfByte1, this.z);

		this.t.a(this, this.p, paramInt1, paramInt2, arrayOfByte1);
		this.y.a(this, this.p, paramInt1, paramInt2, arrayOfByte1);
		if (this.q) {
		...
		byte[] arrayOfByte2 = localChunk.m();

		for (int i1 = 0; i1 < arrayOfByte2.length; i1++) {
			arrayOfByte2[i1] = (byte)this.z[i1].id;
		}
	...
	private double[] a(double[] paramArrayOfDouble, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
	{
		...
		for (int i5 = 0; i5 < paramInt4; i5++) {
			for (int i6 = 0; i6 < paramInt6; i6++) {
				...
				BiomeBase localBiomeBase1 = this.z[(i5 + 2 + (i6 + 2) * (paramInt4 + 5))];
				for (int i8 = -i7; i8 <= i7; i8++) {
					for (int i9 = -i7; i9 <= i7; i9++) {
						BiomeBase localBiomeBase2 = this.z[(i5 + i8 + 2 + (i6 + i9 + 2) * (paramInt4 + 5))];
	...
	public void getChunkAt(IChunkProvider paramIChunkProvider, int paramInt1, int paramInt2)
	{
		...
		if (this.q) {
			...
			this.x.a(this.p, this.k, paramInt1, paramInt2);
		}
		int i4;
		int i5;
		...
		for (i3 = 0; i3 < 16; i3++) {
			for (i4 = 0; i4 < 16; i4++) {
				i5 = this.p.g(i1 + i3, i2 + i4);

				if (this.p.u(i3 + i1, i5 - 1, i4 + i2)) {
					this.p.setTypeId(i3 + i1, i5 - 1, i4 + i2, Block.ICE.id);
				}
				if (this.p.w(i3 + i1, i5, i4 + i2)) {
