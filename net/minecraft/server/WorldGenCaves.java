...
public class WorldGenCaves extends WorldGenBase
{
	...
	{
		a(paramLong, paramInt1, paramInt2, paramArrayOfByte, paramDouble1, paramDouble2, paramDouble3, 1.0F + this.b.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
	}
								...
								if ((i13 == Block.STONE.id) || (i13 == Block.DIRT.id) || (i13 == Block.GRASS.id)) {
									if (i12 < 10) {
										...
										if ((i11 != 0) && (paramArrayOfByte[(i10 - 1)] == Block.DIRT.id))
											paramArrayOfByte[(i10 - 1)] = this.c.getBiome(i6 + paramInt1 * 16, i9 + paramInt2 * 16).A;
									}
								}
							}
							i10--;
	...
	protected void a(World paramWorld, int paramInt1, int paramInt2, int paramInt3, int paramInt4, byte[] paramArrayOfByte) {
		int i = this.b.nextInt(this.b.nextInt(this.b.nextInt(40) + 1) + 1);
		if (this.b.nextInt(15) != 0) i = 0;
		...
		for (int j = 0; j < i; j++) {
			...
			if (this.b.nextInt(4) == 0) {
				a(this.b.nextLong(), paramInt3, paramInt4, paramArrayOfByte, d1, d2, d3);
				k += this.b.nextInt(4);
			}
			...
			for (int m = 0; m < k; m++)
			{
				...
				a(this.b.nextLong(), paramInt3, paramInt4, paramArrayOfByte, d1, d2, d3, f3, f1, f2, 0, 0, 1.0D);
			}
		}
	}
}
