...
public class WorldGenCanyon extends WorldGenBase
{
								...
								if ((i12 == Block.STONE.id) || (i12 == Block.DIRT.id) || (i12 == Block.GRASS.id)) {
									if (i11 < 10) {
										...
										if ((i10 != 0) && (paramArrayOfByte[(i9 - 1)] == Block.DIRT.id))
											paramArrayOfByte[(i9 - 1)] = this.c.getBiome(i5 + paramInt1 * 16, i8 + paramInt2 * 16).A;
									}
								}
							}
							i9--;
	...
	protected void a(World paramWorld, int paramInt1, int paramInt2, int paramInt3, int paramInt4, byte[] paramArrayOfByte) {
		...
		for (int j = 0; j < i; j++)
		{
			...
			a(this.b.nextLong(), paramInt3, paramInt4, paramArrayOfByte, d1, d2, d3, f3, f1, f2, 0, 0, 3.0D);
		}
	}
}
