...
public class BlockFlowing extends BlockFluids
{
	...
	private int d(World world, int i, int j, int k, int l, int i1) {
		...
		for (int k1 = 0; k1 < 4; k1++) {
			if (((k1 != 0) || (i1 != 1)) && ((k1 != 1) || (i1 != 0)) && ((k1 != 2) || (i1 != 3)) && ((k1 != 3) || (i1 != 2))) {
				...
				if ((!o(world, l1, j, i2)) && ((world.getMaterial(l1, j, i2) != this.material) || (world.getData(l1, j, i2) != 0))) {
	...
	private boolean[] n(World world, int i, int j, int k)
	{
		for (int l = 0; l < 4; l++) {
			...
			if ((!o(world, i1, j, j1)) && ((world.getMaterial(i1, j, j1) != this.material) || (world.getData(i1, j, j1) != 0))) {
				if (o(world, i1, j - 1, j1))
					this.c[l] = d(world, i1, j, j1, 1, l);
				else {
					this.c[l] = 0;
				}
			}
