		...
		if ((this.f++ == 100) && (!this.world.isStatic)) {
			...
			if ((!this.dead) && (!survives()))
			{
				...
				if (material.equals(Material.WATER)) {
					cause = PaintingBreakEvent.RemoveCause.WATER;
				}
				else
				{
					PaintingBreakEvent.RemoveCause cause;
					...
					else cause = PaintingBreakEvent.RemoveCause.PHYSICS;
				}
	...
	public boolean damageEntity(DamageSource damagesource, int i) {
		if ((!this.dead) && (!this.world.isStatic))
		{
			...
			if (damagesource.getEntity() != null) {
				event = new PaintingBreakByEntityEvent((Painting)getBukkitEntity(), damagesource.getEntity() == null ? null : damagesource.getEntity().getBukkitEntity());
			}
