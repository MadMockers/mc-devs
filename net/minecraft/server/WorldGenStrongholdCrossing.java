...
public class WorldGenStrongholdCrossing extends WorldGenStrongholdPiece
{
	...
	public WorldGenStrongholdCrossing(int paramInt1, Random paramRandom, StructureBoundingBox paramStructureBoundingBox, int paramInt2)
	{
		...
		this.h = (paramRandom.nextInt(3) > 0);
	}
	...
	public void a(StructurePiece paramStructurePiece, List paramList, Random paramRandom)
	{
		...
		if (this.b) b((WorldGenStrongholdStart)paramStructurePiece, paramList, paramRandom, i, 1);
		if (this.c) b((WorldGenStrongholdStart)paramStructurePiece, paramList, paramRandom, j, 7);
		if (this.d) c((WorldGenStrongholdStart)paramStructurePiece, paramList, paramRandom, i, 1);
		if (this.h) c((WorldGenStrongholdStart)paramStructurePiece, paramList, paramRandom, j, 7);
	}
	...
	public boolean a(World paramWorld, Random paramRandom, StructureBoundingBox paramStructureBoundingBox)
	{
		...
		if (this.h) a(paramWorld, paramStructureBoundingBox, 9, 5, 7, 9, 7, 9, 0, 0, false);
