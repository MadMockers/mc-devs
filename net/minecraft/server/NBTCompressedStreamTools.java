...
public class NBTCompressedStreamTools
{
	public static NBTTagCompound a(InputStream paramInputStream)
	{
		...
		try {
			NBTTagCompound localNBTTagCompound = a(localDataInputStream);
			return localNBTTagCompound; } finally { localDataInputStream.close(); } throw localObject;
	}
...
/* 
 * Qualified Name:		 net.minecraft.server.NBTCompressedStreamTools
