...
public class BlockPistonExtension extends Block
{
	...
	public void remove(World world, int i, int j, int k, int l, int i1) {
		...
		if ((i1 & 0x7) >= Facing.OPPOSITE_FACING.length) return;
	...
	public int a(int i, int j) {
		...
		return (k < 6) && (i == Facing.OPPOSITE_FACING[k]) ? 107 : i == k ? this.textureId : (j & 0x8) != 0 ? this.textureId - 1 : this.a >= 0 ? this.a : 108;
	}
