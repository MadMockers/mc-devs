...
public class BlockPiston extends Block
{
	...
	public int a(int i, int j) {
		...
		return i == Facing.OPPOSITE_FACING[k] ? 109 : i == k ? 110 : (!f(j)) && (this.minX <= 0.0D) && (this.minY <= 0.0D) && (this.minZ <= 0.0D) && (this.maxX >= 1.0D) && (this.maxY >= 1.0D) && (this.maxZ >= 1.0D) ? this.textureId : k > 5 ? this.textureId : 108;
	}
