		...
		for (int n = 0; n < paramInt4; n++) {
			for (int i1 = 0; i1 < paramInt3; i1++) {
				...
				if ((i6 == 0) && ((i2 != 0) || (i3 != 0) || (i4 != 0) || (i5 != 0))) {
					...
					else if (i8 == BiomeBase.ICE_PLAINS.id) arrayOfInt2[(i1 + n * paramInt3)] = BiomeBase.FROZEN_OCEAN.id; else
						arrayOfInt2[(i1 + n * paramInt3)] = 0;
				}
				else if ((i6 > 0) && ((i2 == 0) || (i3 == 0) || (i4 == 0) || (i5 == 0))) {
					if (a(5) == 0) {
						if (i6 == BiomeBase.ICE_PLAINS.id) arrayOfInt2[(i1 + n * paramInt3)] = BiomeBase.FROZEN_OCEAN.id; else
							arrayOfInt2[(i1 + n * paramInt3)] = 0;
 ...
 * Qualified Name:		 net.minecraft.server.GenLayerIsland
