...
public abstract class PathfinderGoalTarget extends PathfinderGoal
{
	...
	protected boolean a(EntityLiving entityliving, boolean flag) {
		...
		if (!entityliving.isAlive())
			return false;
		if ((entityliving.boundingBox.e > this.d.boundingBox.b) && (entityliving.boundingBox.b < this.d.boundingBox.e)) {
			...
			if (entityliving.getBukkitEntity() != event.getTarget()) {
				this.d.b((EntityLiving)((CraftEntity)event.getTarget()).getHandle());
			}
