...
public class RecipesFurnace
{
	...
	public RecipesFurnace() {
		...
		registerRecipe(Item.PORK.id, new ItemStack(Item.GRILLED_PORK), 0.3F);
		registerRecipe(Item.RAW_BEEF.id, new ItemStack(Item.COOKED_BEEF), 0.3F);
		registerRecipe(Item.RAW_CHICKEN.id, new ItemStack(Item.COOKED_CHICKEN), 0.3F);
		registerRecipe(Item.RAW_FISH.id, new ItemStack(Item.COOKED_FISH), 0.3F);
		registerRecipe(Block.COBBLESTONE.id, new ItemStack(Block.STONE), 0.1F);
		registerRecipe(Item.CLAY_BALL.id, new ItemStack(Item.CLAY_BRICK), 0.2F);
		registerRecipe(Block.CACTUS.id, new ItemStack(Item.INK_SACK, 1, 2), 0.2F);
		registerRecipe(Block.LOG.id, new ItemStack(Item.COAL, 1, 1), 0.1F);
