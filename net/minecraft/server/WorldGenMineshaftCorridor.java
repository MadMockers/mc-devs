...
public class WorldGenMineshaftCorridor extends StructurePiece
{
	...
	public void a(StructurePiece paramStructurePiece, List paramList, Random paramRandom)
	{
		...
		case 2:
			if (j <= 1)
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a, this.e.b - 1 + paramRandom.nextInt(3), this.e.c - 1, this.f, i);
			else if (j == 2)
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a - 1, this.e.b - 1 + paramRandom.nextInt(3), this.e.c, 1, i);
			else {
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.d + 1, this.e.b - 1 + paramRandom.nextInt(3), this.e.c, 3, i);
			}
			break;
		case 0:
			if (j <= 1)
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a, this.e.b - 1 + paramRandom.nextInt(3), this.e.f + 1, this.f, i);
			else if (j == 2)
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a - 1, this.e.b - 1 + paramRandom.nextInt(3), this.e.f - 3, 1, i);
			else {
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.d + 1, this.e.b - 1 + paramRandom.nextInt(3), this.e.f - 3, 3, i);
			}
			break;
		case 1:
			if (j <= 1)
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a - 1, this.e.b - 1 + paramRandom.nextInt(3), this.e.c, this.f, i);
			else if (j == 2)
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a, this.e.b - 1 + paramRandom.nextInt(3), this.e.c - 1, 2, i);
			else {
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a, this.e.b - 1 + paramRandom.nextInt(3), this.e.f + 1, 0, i);
			}
			break;
		case 3:
			if (j <= 1)
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.d + 1, this.e.b - 1 + paramRandom.nextInt(3), this.e.c, this.f, i);
			else if (j == 2)
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.d - 3, this.e.b - 1 + paramRandom.nextInt(3), this.e.c - 1, 2, i);
			else {
				WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.d - 3, this.e.b - 1 + paramRandom.nextInt(3), this.e.f + 1, 0, i);
			}
		...
		if (i < 8)
		{
			...
			if ((this.f == 2) || (this.f == 0)) {
				for (k = this.e.c + 3; k + 3 <= this.e.f; k += 5) {
					...
					if (m == 0)
						WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a - 1, this.e.b, k, 1, i + 1);
					else if (m == 1)
						WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.d + 1, this.e.b, k, 3, i + 1);
				}
			}
			else
				for (k = this.e.a + 3; k + 3 <= this.e.d; k += 5) {
					m = paramRandom.nextInt(5);
					if (m == 0)
						WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, k, this.e.b, this.e.c - 1, 2, i + 1);
					else if (m == 1)
						WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, k, this.e.b, this.e.f + 1, 0, i + 1);
				}
		}
	}
	...
	public boolean a(World paramWorld, Random paramRandom, StructureBoundingBox paramStructureBoundingBox)
	{
		...
		for (int j = 0; j < this.d; j++)
		{
			...
			if ((this.b) && (!this.c)) {
				m = a(0); int n = k - 1 + paramRandom.nextInt(3);
				int i1 = a(1, n);
				n = b(1, n);
				if (paramStructureBoundingBox.b(i1, m, n)) {
					...
					if (localTileEntityMobSpawner == null) continue; localTileEntityMobSpawner.a("CaveSpider");
				}
			}
