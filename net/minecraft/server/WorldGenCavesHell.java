...
/*	19 */		 float f1 = 0.0F;
/*	20 */		 float f2 = 0.0F;
/*	21 */		 Random localRandom = new Random(this.b.nextLong());
/*		 */ 
/*	23 */		 if (paramInt4 <= 0) {
/*	24 */			 i = this.a * 16 - 16;
...
/*	61 */				 a(paramInt1, paramInt2, paramArrayOfByte, paramDouble1, paramDouble2, paramDouble3, localRandom.nextFloat() * 0.5F + 0.5F, paramFloat2 - 1.570796F, paramFloat3 / 3.0F, paramInt3, paramInt4, 1.0D);
/*	62 */				 a(paramInt1, paramInt2, paramArrayOfByte, paramDouble1, paramDouble2, paramDouble3, localRandom.nextFloat() * 0.5F + 0.5F, paramFloat2 + 1.570796F, paramFloat3 / 3.0F, paramInt3, paramInt4, 1.0D);
/*	63 */				 return;
/*		 */			 }
...
/* 103 */						 if ((i8 >= 0) && (i8 < 128)) {
/* 104 */							 if ((paramArrayOfByte[i9] == Block.LAVA.id) || (paramArrayOfByte[i9] == Block.STATIONARY_LAVA.id)) {
/* 105 */								 i5 = 1;
/*		 */							 }
...
/* 120 */					 for (int i11 = i2 - 1; i11 >= i1; i11--) {
/* 121 */						 double d11 = (i11 + 0.5D - paramDouble2) / d4;
/* 122 */						 if ((d11 > -0.7D) && (d9 * d9 + d11 * d11 + d10 * d10 < 1.0D)) {
/* 123 */							 int i12 = paramArrayOfByte[i10];
/* 124 */							 if ((i12 == Block.NETHERRACK.id) || (i12 == Block.DIRT.id) || (i12 == Block.GRASS.id)) {
/* 125 */								 paramArrayOfByte[i10] = 0;
/*		 */							 }
/*		 */						 }
/* 128 */						 i10--;
/*		 */					 }
...
/* 138 */		 int i = this.b.nextInt(this.b.nextInt(this.b.nextInt(10) + 1) + 1);
/* 139 */		 if (this.b.nextInt(5) != 0) i = 0;
/*		 */ 
/* 141 */		 for (int j = 0; j < i; j++) {
/* 142 */			 double d1 = paramInt1 * 16 + this.b.nextInt(16);
/* 143 */			 double d2 = this.b.nextInt(128);
/* 144 */			 double d3 = paramInt2 * 16 + this.b.nextInt(16);
/*		 */ 
/* 146 */			 int k = 1;
/* 147 */			 if (this.b.nextInt(4) == 0) {
/* 148 */				 a(paramInt3, paramInt4, paramArrayOfByte, d1, d2, d3);
/* 149 */				 k += this.b.nextInt(4);
/*		 */			 }
/*		 */ 
/* 152 */			 for (int m = 0; m < k; m++)
/*		 */			 {
/* 154 */				 float f1 = this.b.nextFloat() * 3.141593F * 2.0F;
/* 155 */				 float f2 = (this.b.nextFloat() - 0.5F) * 2.0F / 8.0F;
/* 156 */				 float f3 = this.b.nextFloat() * 2.0F + this.b.nextFloat();
/*		 */ 
/* 158 */				 a(paramInt3, paramInt4, paramArrayOfByte, d1, d2, d3, f3 * 2.0F, f1, f2, 0, 0, 0.5D);
/*		 */			 }
/*		 */		 }
/*		 */	 }
/*		 */ }
 ...
 * Qualified Name:		 net.minecraft.server.WorldGenCavesHell
