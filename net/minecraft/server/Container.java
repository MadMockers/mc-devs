...
public abstract class Container
{
	...
	public void transferTo(Container other, CraftHumanEntity player) { InventoryView source = getBukkitView(); InventoryView destination = other.getBukkitView();
	...
	{
		clickItem(i, j, flag, entityhuman);
	}
