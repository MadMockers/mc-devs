...
public class WorldGenMineshaftStairs extends StructurePiece
{
	...
	public void a(StructurePiece paramStructurePiece, List paramList, Random paramRandom)
	{
		...
		switch (this.f) {
		case 2:
			WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a, this.e.b, this.e.c - 1, 2, i);
			break;
		case 0:
			WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a, this.e.b, this.e.f + 1, 0, i);
			break;
		case 1:
			WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.a - 1, this.e.b, this.e.c, 1, i);
			break;
		case 3:
			WorldGenMineshaftPieces.a(paramStructurePiece, paramList, paramRandom, this.e.d + 1, this.e.b, this.e.c, 3, i);
		}
	}
