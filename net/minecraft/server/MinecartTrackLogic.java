...
class MinecartTrackLogic
{
	...
	{
		return BlockMinecartTrack.d_(this.b, i, j + 1, k) ? true : BlockMinecartTrack.d_(this.b, i, j, k) ? true : BlockMinecartTrack.d_(this.b, i, j - 1, k);
	}

	private MinecartTrackLogic a(ChunkPosition chunkposition) {
		return BlockMinecartTrack.d_(this.b, chunkposition.x, chunkposition.y - 1, chunkposition.z) ? new MinecartTrackLogic(this.a, this.b, chunkposition.x, chunkposition.y - 1, chunkposition.z) : BlockMinecartTrack.d_(this.b, chunkposition.x, chunkposition.y + 1, chunkposition.z) ? new MinecartTrackLogic(this.a, this.b, chunkposition.x, chunkposition.y + 1, chunkposition.z) : BlockMinecartTrack.d_(this.b, chunkposition.x, chunkposition.y, chunkposition.z) ? new MinecartTrackLogic(this.a, this.b, chunkposition.x, chunkposition.y, chunkposition.z) : null;
	}
	...
	public void a(boolean flag, boolean flag1)
	{
		...
		if ((flag1) || (this.b.getData(this.c, this.d, this.e) != i)) {
			...
			while (iterator.hasNext()) {
				...
				MinecartTrackLogic minecarttracklogic = a(chunkposition);
