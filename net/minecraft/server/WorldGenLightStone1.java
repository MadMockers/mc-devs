	...
	public boolean a(World paramWorld, Random paramRandom, int paramInt1, int paramInt2, int paramInt3)
	{
		...
		for (int i = 0; i < 1500; i++) {
			...
			for (int i1 = 0; i1 < 6; i1++) {
				...
				if (i2 != Block.GLOWSTONE.id) continue; n++;
			}

			if (n != 1) continue; paramWorld.setTypeId(j, k, m, Block.GLOWSTONE.id);
		}
...
/* 
 * Qualified Name:		 net.minecraft.server.WorldGenLightStone1
