...
public class GenLayerZoom extends GenLayer
{
	...
	protected int b(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
		...
		if ((paramInt2 == paramInt1) && (paramInt3 != paramInt4)) return paramInt2;
		if ((paramInt2 == paramInt3) && (paramInt1 != paramInt4)) return paramInt2;
		if ((paramInt2 == paramInt4) && (paramInt1 != paramInt3)) return paramInt2;

		if ((paramInt3 == paramInt1) && (paramInt2 != paramInt4)) return paramInt3;
		if ((paramInt3 == paramInt2) && (paramInt1 != paramInt4)) return paramInt3;
		if ((paramInt3 == paramInt4) && (paramInt1 != paramInt2)) return paramInt3;

		if ((paramInt4 == paramInt1) && (paramInt2 != paramInt3)) return paramInt3;
		if ((paramInt4 == paramInt2) && (paramInt1 != paramInt3)) return paramInt3;
		if ((paramInt4 == paramInt3) && (paramInt1 != paramInt2)) return paramInt3;
 ...
 * Qualified Name:		 net.minecraft.server.GenLayerZoom
