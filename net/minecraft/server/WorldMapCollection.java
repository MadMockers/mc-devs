...
public class WorldMapCollection
{
	...
	public void a() {
		for (WorldMapBase localWorldMapBase : this.c)
	...
	private void a(WorldMapBase paramWorldMapBase)
	{
		if (this.a == null) return; try
		{
			...
			if (localFile != null) {
				...
				NBTCompressedStreamTools.a(localNBTTagCompound2, localFileOutputStream);
	...
	private void b() {
		try {
			...
			if ((localFile != null) && (localFile.exists())) {
				...
				for (NBTBase localNBTBase : localNBTTagCompound.c())
	...
	public int a(String paramString) {
		...
		if (this.a == null) return localShort.shortValue(); try
		{
			...
			if (localObject1 != null) {
				...
				localObject3 = new DataOutputStream(new FileOutputStream((File)localObject1));
