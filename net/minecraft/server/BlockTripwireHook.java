...
public class BlockTripwireHook extends Block
{
	...
	public void postPlace(World world, int i, int j, int k, int l, float f, float f1, float f2) {
		...
		a(world, i, j, k, this.id, b0, false, -1, 0);
	}
	...
	{
		int l1 = i1 & 0x3;
		boolean flag1 = (i1 & 0x4) == 4;
		boolean flag2 = (i1 & 0x8) == 8;
		...
		for (int i3 = 1; i3 < 42; i3++) {
			int l2 = i + i2 * i3;
			int k3 = k + j2 * i3;
			int j3 = world.getTypeId(l2, j, k3);
			if (j3 == Block.TRIPWIRE_SOURCE.id) {
				int l3 = world.getData(l2, j, k3);
				if ((l3 & 0x3) != Direction.e[l1]) break;
				k2 = i3; break;
			}
			...
			if ((j3 != Block.TRIPWIRE.id) && (i3 != j1)) {
				...
				int l3 = i3 == j1 ? k1 : world.getData(l2, j, k3);
				boolean flag6 = (l3 & 0x8) != 8;
				boolean flag7 = (l3 & 0x1) == 1;
				boolean flag8 = (l3 & 0x2) == 2;
		...
		if (k2 > 0) {
			int l2 = i + i2 * k2;
			int k3 = k + j2 * k2;
			int j3 = Direction.e[l1];
			world.setData(l2, j, k3, j3 | i3);
			e(world, l2, j, k3, j3);
			a(world, l2, j, k3, flag3, flag4, flag1, flag2);
		}
		...
		a(world, i, j, k, flag3, flag4, flag1, flag2);
		if (l > 0) {
	...
	{
		a(world, i, j, k, this.id, world.getData(i, j, k), true, -1, 0);
	}
	...
	{
		boolean flag = (i1 & 0x4) == 4;
		boolean flag1 = (i1 & 0x8) == 8;

		if ((flag) || (flag1)) {
			a(world, i, j, k, 0, i1, false, -1, 0);
		}
	...
	public boolean a(IBlockAccess iblockaccess, int i, int j, int k, int l) {
		return (iblockaccess.getData(i, j, k) & 0x8) == 8;
	}
